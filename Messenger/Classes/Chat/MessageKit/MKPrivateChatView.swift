...
//-------------------------------------------------------------------------------------------------------------------------------------------------
class MKPrivateChatView: MessagesViewController {
...
// MARK: - AudioDelegate
//-------------------------------------------------------------------------------------------------------------------------------------------------
extension MKPrivateChatView: AudioDelegate {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
extension MKPrivateChatView: MessagesDataSource {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
extension MKPrivateChatView: MessageCellDelegate {
