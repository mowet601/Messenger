...
//-------------------------------------------------------------------------------------------------------------------------------------------------
class RCGroupChatView: RCMessagesView, UIGestureRecognizerDelegate {
	...
	func updateTitleDetails() {
		...
		if let group = realm.object(ofType: Group.self, forPrimaryKey: chatId) {
			labelTitle1.text = group.name
		}

		let userIds = Members.userIds(chatId: chatId)
		labelTitle2.text = "\(userIds.count) members"
	}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
extension RCGroupChatView: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
// MARK: - AudioDelegate
//-------------------------------------------------------------------------------------------------------------------------------------------------
extension RCGroupChatView: AudioDelegate {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
extension RCGroupChatView: StickersDelegate {
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
extension RCGroupChatView: SelectUsersDelegate {
